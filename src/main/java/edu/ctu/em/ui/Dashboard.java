...
public class Dashboard extends javax.swing.JFrame {
    private EmployeeManagement emManage;
    private SalaryManagement saManage;
    /**
...
//        lg.setVisible(true);
    ...
    private void initComponents() {
        ...
        mnuME = new javax.swing.JMenuItem();
        ...
        mnuME.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        mnuME.setIcon(new javax.swing.ImageIcon(getClass().getResource("/edu/ctu/em/icons/teamwork-16.png"))); // NOI18N
        mnuME.setText("Manage Employee");
        mnuME.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                mnuMEActionPerformed(evt);
            }
        });
        jMenu1.add(mnuME);
        ...
        mnuMS.setIcon(new javax.swing.ImageIcon(getClass().getResource("/edu/ctu/em/icons/salary-16.png"))); // NOI18N
        mnuMS.setText("Manage Salary");
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(tplDashBoard, javax.swing.GroupLayout.DEFAULT_SIZE, 582, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void mnuMEActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnuMEActionPerformed
        if(emManage == null){
            emManage = new EmployeeManagement();
            ImageIcon icon = new ImageIcon(getClass().getResource("/edu/ctu/em/icons/teamwork-16.png"));
            tplDashBoard.addTab("Employee Management  ", icon, emManage, "Employee Management");
        }
        tplDashBoard.setSelectedComponent(emManage);
    }//GEN-LAST:event_mnuMEActionPerformed

    private void mnuMSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnuMSActionPerformed
        if(saManage == null){
            saManage = new SalaryManagement();
            ImageIcon icon = new ImageIcon(getClass().getResource("/edu/ctu/em/icons/salary-16.png"));
            tplDashBoard.addTab("Salary Management  ", icon, saManage, "Salary Management");
        }
        tplDashBoard.setSelectedComponent(saManage);
    ...
    private void processLoginSuccessful(){
        ...
        String role = "";
        if(SharedData.LoginUser.getRole()==0) role="Admin";
        else if(SharedData.LoginUser.getRole()==1) role="Human Resources";
        else if(SharedData.LoginUser.getRole()==2) role="Accountant";
        lblRole.setText("Role: " + role);
        
        tplDashBoard.removeAll();
        if(role.equals("Human Resources")){
            mnuME.setEnabled(true);
            if(emManage == null){
                emManage = new EmployeeManagement();
                ImageIcon icon = new ImageIcon(getClass().getResource("/edu/ctu/em/icons/teamwork-16.png"));
                tplDashBoard.addTab("Employee Management  ", icon, emManage, "Employee Management");
    ...
    private javax.swing.JMenuItem mnuME;
